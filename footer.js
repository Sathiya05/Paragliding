...
<footer class="relative w-full overflow-hidden transition-colors duration-300 bg-white dark:bg-[#050505] border-t border-gray-200 dark:border-gray-900 font-sans">
  ...
  <div class="mt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid gap-12 grid-cols-1 lg:grid-cols-12 relative z-10">

    <div class="lg:col-span-4 pr-0 lg:pr-8 flex flex-col items-center text-center lg:items-start lg:text-left">
    ...
    <div class="lg:col-span-4 grid grid-cols-1 md:grid-cols-2 gap-8 text-center lg:text-left">
      
      <div class="flex flex-col items-center lg:items-start">
        <h3 class="text-[13px] font-black mb-6 uppercase tracking-[0.15em] text-black dark:text-white flex items-center justify-center lg:justify-start gap-2 w-full">
          <i class="fas fa-parachute-box text-[#3A86FF]"></i> Adventures
        </h3>
        <ul class="space-y-4 text-[14px] font-semibold w-full">
          <li><a href="packages.html#missions" class="footer-link text-gray-500 dark:text-gray-400">Tandem Paragliding</a></li>
          <li><a href="packages.html#missions" class="footer-link text-gray-500 dark:text-gray-400">Hang Gliding</a></li>
          <li><a href="packages.html#missions" class="footer-link text-gray-500 dark:text-gray-400">Acrobatic Flights</a></li>
      ...
      <div class="flex flex-col items-center lg:items-start">
        ...
        <ul class="space-y-4 text-[14px] font-semibold w-full">
          <li><a href="about.html" class="footer-link text-gray-500 dark:text-gray-400">About Our Pilots</a></li>
          <li><a href="packages.html" class="footer-link text-gray-500 dark:text-gray-400">Pricing & Packages</a></li>
          <li><a href="flights.html" class="footer-link text-gray-500 dark:text-gray-400">Safety & Weather</a></li>
          <li><a href="contact.html" class="footer-link text-gray-500 dark:text-gray-400">Contact & Location</a></li>
        </ul>
      </div>
  ...
  <div class="border-t border-gray-100 dark:border-gray-900 bg-transparent transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row gap-6 justify-between items-center text-[11px] font-bold tracking-[0.1em] text-gray-400 dark:text-gray-500 text-center">
